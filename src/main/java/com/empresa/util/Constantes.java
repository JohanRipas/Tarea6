...
public class Constantes {
	...
	public static final String MENSAJE_ACT_YA_EXISTE = "Ya existe el registro.";
	...
	public static final String MENSAJE_ACT_NO_EXISTE_ID = "No existe el ID que quiere actualizar.";
	...
	public static final String MENSAJE_ELI_NO_EXISTE_ID = "No existe el ID que quiere eliminar.";
